...
export const PriceTag:FC<PriceTagProps> = ({currentPrice,onSale, oldPrice,discountPercent, className}) => {
	return (<div className={`bg-linear-[var(--dark-300),var(--dark-500)] w-fit rounded ${className}`}>
		{ onSale ?
			<div className={'flex gap-2 items-center'}>
				<div className={"bg-green-900 py-3 px-1"}>
					<span className="text-green-300! text-md">-{discountPercent}%</span>
				</div>
